...
![image of process](images/Dll-injection-createremotethread.png)
   ...
   1. [**OpenProcess()**](https://docs.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-openprocess) OpenProcess() is responsible for setting up access to a process object and returning a handle to us as means of communication with the process we select.
